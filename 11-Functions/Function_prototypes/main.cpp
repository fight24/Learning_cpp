...
// function prototype
double calc_area_circle(double); // double calc_area_circle(double r);
double calc_volume_cylinder(double, double); // double calc_volume_cylinder(double r, double h);
void area_circle(); 
